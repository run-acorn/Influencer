		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">게시판 글수정</h2>
				</div>
			</div>
			<div class="row justify-content-center">
				<div class="col-lg-10">
					<div class="wrapper img" style="background-image: url(images/img.jpg);">
						<div class="row">
				            ...
				            Your message was sent, thank you!
									...
									<form action="${cpath}/boardUpdate.do?board_no=${vo.board_no}" method="POST" id="boardUpdate" name="boardUpdate" class="contactForm">
										<div class="row">
											<div class="col-md-4"> 
												<div class="form-group">
													<label class="label" for="email">머리글</label>
													<select name="board_head" class="selectpicker" data-style="btn btn-success">
													<option value="">${vo.board_head}</option>
											...
											<div class="col-md-12">
												<div class="form-group">
													...
													<input type="text" class="form-control" name="board_title" id="board_title" value="${vo.board_title}">
												</div>
											</div>
											...
											<div class="col-md-12">
												...
												<label class="label" for="name">닉네임</label>
													<input type=text class="form-control" name="nick" id="nick" placeholder="Subject" value="${vo.nick}" readonly>
												</div>
											</div>
											...
											<div class="col-md-12">
												<div class="form-group">
													...
													<textarea name="board_content" class="form-control" id="board_content" cols="30" rows="20">${vo.board_content}</textarea>
												</div>
											</div>
											<div class="col-md-12">
												<div class="form-group">
